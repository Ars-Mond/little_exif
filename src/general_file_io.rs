...
/// Hard cap on a single allocation from untrusted size fields (64 MiB).
/// Protects against OOM from malformed or malicious files.
pub(crate) const MAX_ALLOCATION_SIZE: usize = 64 * 1024 * 1024;
